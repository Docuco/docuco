...
export function StopSharingFolderModal({
    folder,
    opened,
    onClose
}: {
    ...
    async function stopSharing() {
        ...
        await clientCustomFetch(`${API_ROUTES.FOLDER_SHARE(folder.id)}`, {
            method: 'DELETE',
        })
    ...
    return (
        <Modal opened={opened} onClose={onClose} title="Link to share" centered overlayProps={{
            ...
            <Space h="lg" />
            <Text c='dimmed'>
                All the people with the link will not be able to access the folder anymore.
            </Text>
            <Space h="lg" />
