...
export class DocuFileDeleted extends DomainEvent {

    static readonly EVENT_NAME = 'docuco.documents.docuFile.deleted';
    ...
    constructor(params: Params) {
        ...
        super({ eventName: DocuFileDeleted.EVENT_NAME, entityId, eventId, occurredOn });
